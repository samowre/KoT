...
;         (why-argument-type (pvs2why-type (type (argument expr))))
	 ...
	 (bind-ids (pvs2why-make-bindings bind-decls bindings))
	 (why-id (id (car bind-decls)))
	 (why-type (or (pvs2why-type (type (car bind-decls))) (type why-argument)))
;	 (why-var (mk-why-binding (id (car bind-decls))
;				  (type why-argument)))
;				  (if (pvs2why-type (type (car bind-decls)))
;				      (pvs2why-type (type (car bind-decls)))
;				      (type why-argument))))
